 ...
 * 
 * --verbose --topic --durable --parallel-threads=3 url=tcp://localhost:61610
 */
public class ConsumerTool extends Thread implements MessageListener, ExceptionListener {
    ...
    public static void main(String[] args) {
        ...
        for (int threadCount = 1; threadCount <= parallelThreads; threadCount++) {
        	...
        	switch (threadCount){
	        	case 1: consumerTool.setClientId("Bipin");break;
	        	case 2: consumerTool.setClientId("Neha");break;
	        	case 3: consumerTool.setClientId("Shaurya");break;
        	}
        	consumerTool.start();
